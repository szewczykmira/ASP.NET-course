...
namespace Deklaracje.Migrations
{
    [DbContext(typeof(ApplicationDbContext))]
    [Migration("20160110124236_Initial")]
    partial class Initial
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Deklaracje.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Deklaracje.Models.DeclarationModel", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Deklaracje.Models.ApplicationUser")
                        .WithMany()
